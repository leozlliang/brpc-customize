...
public class BrpcProviderAomiInterceptor extends AbstractBrpcAomiInterceptor {
    public BrpcProviderAomiInterceptor() {
        this.isConsumerSide = Boolean.FALSE;
    }
    ...
    protected Trace startTrace(BrpcTraceInvokeContext invokeContext) {
        ...
        try {
            ...
            this.logger.warn("providerTraceFilter startTrace error", var5);
        }
